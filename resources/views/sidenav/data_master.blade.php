...
<a href="javascript:void(0)"
    class="nav-link {{ Request::is('category') || Request::is('product-book') ? '' : 'collapsed' }}"
...
<div class="collapse {{ Request::is('category') || Request::is('product-book') ? 'show' : '' }}"
    ...
    <nav class="sidenav-menu-nested nav accordion" id="accordionSidenav">
        ...
        <a href="/product-book" class="nav-link {{ Request::is('product-book') ? 'active' : '' }}">
            <div class="nav-link-icon">
